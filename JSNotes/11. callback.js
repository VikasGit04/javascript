...
// This allows you to defer execution of a certain piece of code until a particular task is completed, 
// like handling an asynchronous operation (e.g., a network request, file read operation).

// Key Points about Callbacks:
// Asynchronous Behavior: Callbacks are often used in asynchronous code to ensure that certain tasks are executed 
// only after other tasks are completed.
// Higher-order Functions: Callbacks are a form of higher-order function, as they are functions passed as 
// arguments to other functions.
// Flexibility: Callbacks allow for more flexible code by enabling actions to be defined outside the function 
// they are passed to. (You can decide what to do after a task without changing the main function.)
