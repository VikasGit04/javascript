...
// Syntax
functionName.apply(thisArg, [arg1, arg2, ...args]);
...
// Syntax
const boundFunction = functionName.bind(thisArg, arg1, arg2, ...args);
...
// Method Borrowing:
// Objects may have similar data or functionality, and you might want to reuse a method from one object for 
// another object. Instead of duplicating code, you can "borrow" the method using call, apply, or bind.
...
// Consider two objects that have similar properties but different methods. Instead of writing redundant methods, 
// you can reuse one object's method for another.
...
// Functions like Math.max or Math.min are not methods of arrays, but they can work with arrays when you set this to 
// null and use apply.
...
// With bind, you can create a new function with a fixed this value and optional pre-applied arguments, which is useful 
// for event handlers or callbacks.
