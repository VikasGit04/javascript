...
// 3. Reduce:
// The reduce() method executes a reducer function on each element of the array (from left to right) and returns a single value (like a sum or concatenation).
// Syntax:
// javascript
// Copy code
...
// The sort() function in JavaScript compares elements using an optional comparison function. If no comparison function is provided, it converts the elements to strings and sorts them lexicographically (based on Unicode code points). If a comparison function is provided, it uses that to determine the order.
// 1. Without a Comparison Function:
// When no comparison function is provided, sort() converts the array elements to strings (if they are not strings) and sorts them based on the lexicographic order of those string representations.
// Example:
// javascript
// Copy code
...
// In this case, the numbers are converted to strings and sorted as strings: '1', '10', '3', and '5'. The lexicographic order is: '1', '10', '3', '5'.
